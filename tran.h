...
void _get_Qx(const Ktensor *perm, const double *verts, int divn, int &Iter, double &Q)
{
    ...
    std::ofstream outx("tranx.txt");
    std::ofstream outy("trany.txt");
    std::ofstream outz("tranz.txt");
    for (int k = 0; k < nz; ++k)
        for (int j = 0; j < ny; ++j)
            for (int i = 0; i < nx; ++i)
            {
                ...
                if (i < nx - 1)
                    outx << C(cur, cur + 1) * Darcy_field << " ";
                else
                    outx << "0 ";
                if (j < ny - 1)
                    outy << C(cur, cur + nx) * Darcy_field << " ";
                else
                    outy << "0 ";
                if (k < nz - 1)
                    outz << C(cur, cur + nx * ny) * Darcy_field << " ";
                else
                    outz << "0 ";
            }
    outx.close();
    ...
    std::ofstream outx1("permx.txt");
    std::ofstream outy1("permy.txt");
    std::ofstream outz1("permz.txt");
    for (int k = 0; k < nz; ++k)
        for (int j = 0; j < ny; ++j)
            for (int i = 0; i < nx; ++i)
            {
